...
;
          if (!runningTests) {
            require("zubeirdev/app")["default"].create({"name":"zubeirdev","version":"0.0.0+9adb4cee"});
          }
